...
enum UlduarNPCs
{
    ...
    NPC_STEELFORGED_DEFENDER_GENERATOR_SUMMON = 33572,
    NPC_XT002                               = 33293,
...
enum UlduarGameObjects
{
    ...
    GO_LEVIATHAN_PROTECTIVE_BUBBLE          = 194484,
...
enum UUEventIds
{
    ...
    EVENT_TRAM_PARKED_MIMIRON           = 21393,
    EVENT_TRAM_PARKED_CENTER            = 21394,
};
...
enum UUActions
{
    ...
    ACTION_TOWER_OF_FLAMES_DESTROYED    = 4,
    ACTION_TOWER_OF_LIFE_DESTROYED      = 8,
...
enum UlduarAchievementCriteriaIds
{
    ...
    CRITERIA_CANT_DO_THAT_WHILE_STUNNED_10_SB = 10090,
    CRITERIA_CANT_DO_THAT_WHILE_STUNNED_25_SB = 10091,
    CRITERIA_CANT_DO_THAT_WHILE_STUNNED_10_S  = 10422,
    CRITERIA_CANT_DO_THAT_WHILE_STUNNED_25_S  = 10424,
    CRITERIA_CANT_DO_THAT_WHILE_STUNNED_10_RM = 10423,
    CRITERIA_CANT_DO_THAT_WHILE_STUNNED_25_RM = 10425,
};
...
enum UlduarData
{
    ...
    DATA_THORIM_PREADD_SUMMONS,
    DATA_THORIM_COLOSSUS_SUMMONS,
    DATA_THORIM_GIANT_SUMMONS,
    ...
    DATA_ACTIVE_TOWERS,
    DATA_DESTROYED_TOWERS,
    DATA_STUNNED,
    DATA_FL_OUTRO_FLYING_MACHINE_LANDED,
    DATA_FL_INTRO_START,
    DATA_ARCHMAGE_PENTARUS,
    DATA_ARCHMAGE_RHYDIAN,
...
enum FlameLeviathanOutroPoints
{
    POINT_FL_OUTRO_FLYING_MACHINE_LAND = 1,
    POINT_FL_OUTRO_RHYDIAN_WALK_TO_LANDING,
    POINT_FL_OUTRO_BRANN_WALK_TO_RHYDIAN,
    POINT_FL_HARDMODE_DELLORAH_TO_BRANN
};
...
enum UlduarEvents
{
    ...
    EVENT_BRANN_RADIO,
    EVENT_BRANN_RADIO2,
    EVENT_FL_INTRO_LINE_1,
    EVENT_FL_INTRO_LINE_2,
    EVENT_FL_INTRO_LINE_3,
    EVENT_FL_INTRO_LINE_4,
    EVENT_FL_INTRO_LINE_5,
    EVENT_FL_INTRO_SHIELD_DOWN,
    EVENT_FL_OUTRO_SPAWN,
    EVENT_FL_OUTRO_LINE_1,
    EVENT_FL_OUTRO_LINE_2,
    EVENT_FL_OUTRO_LINE_3,
    EVENT_FL_OUTRO_LINE_4,
    EVENT_FL_OUTRO_LINE_5,
    EVENT_FL_OUTRO_LINE_6,
    EVENT_FL_OUTRO_LINE_7,
    EVENT_FL_OUTRO_LINE_8,
    EVENT_FL_OUTRO_LINE_9,
    EVENT_FL_OUTRO_LINE_10,
    EVENT_FL_OUTRO_LINE_11,
    EVENT_FL_OUTRO_DESPAWN,
    EVENT_FL_HARDMODE_LINE_DEACTIVATING,
    EVENT_FL_HARDMODE_NORGANNON_DESPAWN,
    EVENT_FL_HARDMODE_BRANN_RADIO_WARN_1,
    EVENT_FL_HARDMODE_BRANN_RADIO_WARN_2,
    EVENT_FL_HARDMODE_DELLORAH_YELL_1,
    EVENT_FL_HARDMODE_DELLORAH_RUN,
    EVENT_FL_HARDMODE_DELLORAH_YELL_2,
    EVENT_FL_HARDMODE_BRANN_RESPOND,
    EVENT_FL_GAUNTLET_RADIO_POLL
};
...
enum UlduarTexts
{
    ...
    SAY_BRANN_RADIO_HARDMODE_WARN_1,
    SAY_BRANN_RADIO_GAUNTLET_GENERATORS,
    SAY_BRANN_RADIO_GAUNTLET_IRON_DWARVES,
    SAY_BRANN_RADIO_GAUNTLET_TOWER_FROST,
    SAY_BRANN_RADIO_GAUNTLET_TOWER_LIFE,
    SAY_BRANN_RADIO_GAUNTLET_TOWER_FLAMES,
    SAY_BRANN_RADIO_GAUNTLET_TOWER_STORMS,
    SAY_BRANN_RADIO_GAUNTLET_REPAIR_PAD
};

enum LoreKeeperTexts
{
    SAY_LORE_KEEPER_CONFIRMED    = 5,
    SAY_LORE_KEEPER_DEACTIVATING = 6
};
