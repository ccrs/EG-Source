...
static std::vector<BattlefieldBuildingInfo> const wintergraspBuildingInfo =
{
    ...
    { WORLDSTATE_WINTERTRASP_TOWER_1,                  GO_WINTERGRASP_TOWER_1,                  BATTLEFIELD_BUILDING_TYPE_TOWER },
    { WORLDSTATE_WINTERTRASP_TOWER_2,                  GO_WINTERGRASP_TOWER_2,                  BATTLEFIELD_BUILDING_TYPE_TOWER },
    { WORLDSTATE_WINTERTRASP_TOWER_3,                  GO_WINTERGRASP_TOWER_3,                  BATTLEFIELD_BUILDING_TYPE_TOWER }
};
