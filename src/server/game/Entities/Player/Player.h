...
enum CustomFlags : uint16
{
    ...
    CUSTOM_FLAG_VISUALS_SHAMAN_ACTIVE = 0x04,
    CUSTOM_FLAG_VISUALS_WARLOCK_ACTIVE = 0x08,
    ...
    CUSTOM_FLAG_HARDCORE_DEAD = 0x002,
    CUSTOM_FLAG_HARDCORE_REWARD_10 = 0x004, // one bit per 10-level milestone, up to 0x200 for level 80
    CUSTOM_FLAG_HARDCORE_REWARD_20 = 0x008,
    CUSTOM_FLAG_HARDCORE_REWARD_30 = 0x010,
    CUSTOM_FLAG_HARDCORE_REWARD_40 = 0x020,
    CUSTOM_FLAG_HARDCORE_REWARD_50 = 0x040,
    CUSTOM_FLAG_HARDCORE_REWARD_60 = 0x080,
...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void UpdateHostileAreaState(AreaTableEntry const* zone); // EG
        void RefreshForcedPvPState(bool hardClear); // EG
        ...
        void FlushNonArenaBattlegroundQueues();
