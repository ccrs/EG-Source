...
enum WorldBoolConfigs : uint32
{
    ...
    CONFIG_ACCOUNT_MOUNTS,
    CONFIG_MILESTONE_REWARDS,
    CONFIG_WORLD_CHAT,
    CONFIG_ARENA_1V1_ENABLE,
    CONFIG_ARENA_1V1_SAME_IP_CHECK,
    CONFIG_CROSS_REALM_CHAT,
    CONFIG_CROSS_REALM_CHAT_ANNOUNCE_PEERS,
...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_NETWORK_AUTH_TIMEOUT,
    CONFIG_NETWORK_MAX_CONNECTIONS_PER_IP,
    CONFIG_ARENA_1V1_MIN_LEVEL,
    CONFIG_ARENA_1V1_VENDOR_RATING_OFFSET,
    CONFIG_ARENA_1V1_RATING_DISCARD_TIMER,
    CONFIG_HARDCORE_GRACE_PERIOD,
    CONFIG_REALM_STATUS_INTERVAL,
    CONFIG_REALM_STATUS_TIMEOUT,
    CONFIG_CROSS_REALM_CHAT_POLL_INTERVAL,
    CONFIG_CROSS_REALM_CHAT_MESSAGE_TTL,
    CONFIG_CROSS_REALM_CHAT_BATCH_SIZE,
