...
class TC_GAME_API MotionMaster
{
    public:
        ...
        void MoveFace(WorldObject const* object, uint32 id = EVENT_FACE, Milliseconds duration = 1s);
        void MoveFace(float const orientation, uint32 id = EVENT_FACE, Milliseconds duration = 1s);
