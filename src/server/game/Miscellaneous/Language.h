...
//                                        = 752, see LANG_PINFO_ACC_IP
    ...
    LANG_ERR_TRANSMOG_OK = 20001,
    LANG_ERR_TRANSMOG_INVALID_SLOT = 20002,
    LANG_ERR_TRANSMOG_INVALID_SRC_ENTRY = 20003,
    LANG_ERR_TRANSMOG_MISSING_SRC_ITEM = 20004,
    LANG_ERR_TRANSMOG_MISSING_DEST_ITEM = 20005,
    LANG_ERR_TRANSMOG_INVALID_ITEMS = 20006,
    LANG_ERR_TRANSMOG_NOT_ENOUGH_MONEY = 20007,
    LANG_ERR_TRANSMOG_NOT_ENOUGH_TOKENS = 20008,
    LANG_ERR_UNTRANSMOG_OK = 20009,
    LANG_ERR_UNTRANSMOG_NO_TRANSMOGS = 20010,
    LANG_MASQUERADE_RACE_ENABLED = 20011,
    LANG_ARENA_1V1_QUEUE_ANNOUNCE_JOIN = 20012,
    LANG_ARENA_1V1_QUEUE_ANNOUNCE_EXIT = 20013,
    LANG_HARDCORE_DEATH_PLAYER = 20014,
    LANG_HARDCORE_DEATH_CREATURE = 20015,
    LANG_HARDCORE_DEATH_GENERIC = 20016,
    LANG_HARDCORE_MILESTONE = 20017,
    LANG_HARDCORE_MILESTONE_FINAL = 20018,
    LANG_CROSS_REALM_CHAT_PEER_UP = 20019,
    LANG_CROSS_REALM_CHAT_PEER_DOWN = 20020,
    LANG_MILESTONE_REWARD = 20021,
    LANG_REALM_FIRST_BLOCKED = 20022,
    LANG_REALM_FIRST_UNBLOCKED = 20023,
    LANG_REALM_FIRST_BLOCKED_ANNOUNCE = 20024
};
#endif
