...
void SpellMgr::LoadSpellInfoCorrections()
{
    ...
    // Fear (Bleeding Hollow Tormentor)
    ApplySpellFix({ 33924 }, [](SpellInfo* spellInfo)
    {
        spellInfo->_GetEffect(EFFECT_0).TargetA = SpellImplicitTargetInfo(TARGET_UNIT_TARGET_ANY);
    });
    ...
    // Argent Cannon
    // Reckoning Bomb
    ApplySpellFix({ 57385, 57412 }, [](SpellInfo* spellInfo)
    {
        spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(6); // 100yd
    });

    // Detonating Rune Stones
    ApplySpellFix({ 34387 }, [](SpellInfo* spellInfo)
    {
        spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(34); // 25yd
    });

    // Punch
    ApplySpellFix({ 56746 }, [](SpellInfo* spellInfo)
    {
    ...
    // 45526 Freed Warsong Mage
    // 45527 Freed Warsong Shaman
    // 45514 Freed Warsong Warrior
    ApplySpellFix({ 45526, 45527, 45514 }, [](SpellInfo* spellInfo)
    {
        spellInfo->_GetEffect(EFFECT_0).TargetA = SpellImplicitTargetInfo(TARGET_DEST_TARGET_ENEMY);
    ...
    ApplySpellFix({ 1010 }, [](SpellInfo* spellInfo)
    {
        ...
        spellInfo->_GetEffect(EFFECT_0).BasePoints = -30;
        ...
        spellInfo->_GetEffect(EFFECT_1).BasePoints = -35;
    ...
    // Activate Construct
    ApplySpellFix({ 62488 }, [](SpellInfo* spellInfo)
    {
        spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(13); // 50000yd
    });
    ...
    // Burning Tar
    ApplySpellFix({ 62290 }, [](SpellInfo* spellInfo)
    {
        spellInfo->_GetEffect(EFFECT_0).RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_9_YARDS);
    });

    // Heat Wave
    ApplySpellFix({ 63679 }, [](SpellInfo* spellInfo)
    {
        spellInfo->_GetEffect(EFFECT_0).ApplyAuraPeriod = 15 * IN_MILLISECONDS;;
    });

    // Twisting Blade
    ApplySpellFix({ 47938 }, [](SpellInfo* spellInfo)
    {
        spellInfo->_GetEffect(EFFECT_0).TargetA = SpellImplicitTargetInfo(TARGET_UNIT_TARGET_ENEMY);
    });

    // Cancel Illusion Room Aura
    ApplySpellFix({ 63993 }, [](SpellInfo* spellInfo)
    {
