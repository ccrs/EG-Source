...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_SEL_ANTICHEAT_PLAYER_ACCOUNT_BANS,

    // EG - Recruit-A-Friend reward queue
    LOGIN_UPD_RAF_REWARD_STRANDED,
    LOGIN_SEL_RAF_REWARD_QUEUE,
    LOGIN_UPD_RAF_REWARD_CLAIM,
    LOGIN_SEL_RAF_REWARD_CLAIM_CHECK,
    LOGIN_UPD_RAF_REWARD_DELIVERED,
    LOGIN_UPD_RAF_REWARD_FAILED,

    // EG - Realm status
    LOGIN_REP_REALM_STATUS,
    LOGIN_SEL_REALM_STATUS_PEERS,

    // EG - Cross-realm World Chat
    LOGIN_DEL_REALM_CHAT_INBOX,
    LOGIN_INS_REALM_CHAT_QUEUE,
    LOGIN_SEL_REALM_CHAT_QUEUE,
    LOGIN_DEL_REALM_CHAT_MESSAGE,
    LOGIN_DEL_REALM_CHAT_EXPIRED,
