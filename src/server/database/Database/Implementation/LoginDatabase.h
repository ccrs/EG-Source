...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_INS_ANTICHEAT_LUA_CHEATERS,
    LOGIN_SEL_ANTICHEAT_LUA_CHEATERS,

    LOGIN_SEL_ANTICHEAT_REPORTS,
    LOGIN_REP_ANTICHEAT_REPORTS,
    LOGIN_SEL_ANTICHEAT_REPORTS_BY_AVERAGE,
    LOGIN_SEL_ANTICHEAT_REPORTS_BY_TOTAL,
    LOGIN_DEL_ANTICHEAT_REPORTS,
