...
void LoginDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(LOGIN_SEL_ANTICHEAT_REPORTS_BY_AVERAGE, "SELECT id, guid, average, total_reports, time, realmid FROM account_anticheat_reports WHERE total_reports != 0 AND realmid = ? ORDER BY average DESC LIMIT 10", CONNECTION_SYNCH);
