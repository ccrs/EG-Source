...
-- Iron Construct
UPDATE `creature_template` SET `unit_flags` = 33554432, `mechanic_immune_mask` = 617299839, `HealthModifier` = 86, `DamageModifier` = 13 WHERE `entry` = 33121;
UPDATE `creature_template` SET `unit_flags` = 33554432, `mechanic_immune_mask` = 617299839, `HealthModifier` = 300, `DamageModifier` = 22 WHERE `entry` = 33191;
