DELETE FROM `spell_script_names` WHERE `ScriptName` IN('EG_spell_destroy_deathforged_infernal', 'EG_spell_fel_reaver_sentinel_tag', 'EG_spell_fel_reaver_controller');
INSERT INTO `spell_script_names` (`spell_id`, `ScriptName`) VALUES
(38055, 'EG_spell_destroy_deathforged_infernal'),
(38020, 'EG_spell_fel_reaver_sentinel_tag'),
(38002, 'EG_spell_fel_reaver_controller'),
(38120, 'EG_spell_fel_reaver_controller'),
(38122, 'EG_spell_fel_reaver_controller'),
(38125, 'EG_spell_fel_reaver_controller'),
(38127, 'EG_spell_fel_reaver_controller'),
(38129, 'EG_spell_fel_reaver_controller');
...
UPDATE `creature_template_spell` SET `Spell` = 38488 WHERE (`CreatureID` = 21949) and (`Index` = 0); -- 38052 is triggered from 38488 
